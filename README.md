...
| [firstuser-agent](examples/firstuser-agent) | TypeScript | Autonomous AI agent that investigates a real website and evaluates whether a user can make a decision from available evidence |
